...
<body style="background-image: url('./Images/logout.jpg');background-repeat: no-repeat;background-size: cover;">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        window.confirmLogout = function() {
            window.location.href = 'logout.php?action=logout'; // Redirect to logout script
        };
    });
</script>
