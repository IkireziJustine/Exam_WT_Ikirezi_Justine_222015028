...
<section>
  <h1><u>Inventory form</u></h1>
  <form method="post" onsubmit="return confirmInsert();">
    <label for="inventory_id">Inventory ID:</label>
    <input type="number" id="inventory_id" name="inventory_id"><br><br>
    ...
    <input type="text" id="warehouse_id" name="warehouse_id" required><br><br>
...
include('db_connection.php');
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $stmt = $conn->prepare("INSERT INTO inventory( inventory_id, quantity, product_id, warehouse_id) VALUES (?, ?, ?, ?)");
$stmt->bind_param("ssss",$inventory_id, $quantity, $product_id, $warehouse_id);
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<tr>
                ...
                <td><a href='delete inventory.php?inventory_id=$inventory_id'>Delete</a></td> 
                <td><a href='update inventory.php?inventory_id=$inventory_id'>Update</a></td> 
              </tr>";
        }
    } else {
